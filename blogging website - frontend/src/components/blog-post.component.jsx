        ...
        <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
            <div className="w-full">
                <div className="flex gap-2 items-center mb-7">
                    ...
                    <p className="min-w-fit"> Publié le { getDay(publishedAt) }</p>
                </div>
                ...
                <div className="flex gap-4 mt-7">
                    ...
                    <span className="ml-3 items-center gap-2 text-dark-grey">
            ...
            <div className="h-28 aspect-square bg-grey">
                <img src={ banner } className="w-full h-hull aspect-square object-cover" alt="" />
            </div>
        </Link>
    )
}
